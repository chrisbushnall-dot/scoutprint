...
function renderScoutReport(player){
  ...
  if(player.development!=null)sentences.push(`Comparable season-on-season Current Level movement is ${signedValue(player.development,1)}; use the Development tab to inspect the supported transition.`);else sentences.push("A comparable consecutive-season development reading is not available, so no trajectory is inferred.");
