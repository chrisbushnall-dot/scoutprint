...
Publish the final recommendation-quality pass through GitHub MCP → Main → Vercel, verify Messi
2020/21 and Salah 2017/18 on the authenticated production path and mobile viewport, then stop.
